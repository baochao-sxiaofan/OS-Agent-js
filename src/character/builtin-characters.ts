...
export const COORDINATOR_CHARACTER: CharacterDefinition = {
  ...
  promptFragment: [
    ...
    'Decide whether to work directly or delegate independent work to available character types.',
    'Give each child only the minimum capability scope required for its assignment.',
    'Integrate child results and remain accountable for the final answer.',
  ].join(' '),
