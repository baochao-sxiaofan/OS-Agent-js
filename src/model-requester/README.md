...
or tool execution enter this module. Existing legacy model providers remain
unchanged and do not call this requester yet. A later migration layer will build
Agent prompts, persist continuation data and interpret model actions outside
