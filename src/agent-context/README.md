...
ACB imports this public contract directly. Existing task-oriented context
management remains independent and unchanged; no compatibility adapter connects
the two structures yet.
